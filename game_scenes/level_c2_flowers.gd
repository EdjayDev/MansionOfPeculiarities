extends BaseLevel
class_name Level_C2_Flowers

func _ready() -> void:
	set_level_name("FIeld Of Flowers")
	scene_path = "res://game_scenes/level_c2_flowers.tscn"
	await init_level()
...
func companion_subdialog()->void:
	var random_subdialog = [
		"This place...[Emphasis] it's surreal",
		"There must've been something we can find here.",
	]
	var picked_subdialog = random_subdialog.pick_random()
